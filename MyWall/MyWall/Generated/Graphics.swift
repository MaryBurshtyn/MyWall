...
internal enum Asset {
  ...
  internal static let icCharts = ImageAsset(name: "ic_charts")
  internal static let icExpense = ImageAsset(name: "ic_expense")
  internal static let icHome = ImageAsset(name: "ic_home")
  internal static let icIncome = ImageAsset(name: "ic_income")
  ...
  internal static let pension = ImageAsset(name: "pension")
  internal static let prize = ImageAsset(name: "prize")
